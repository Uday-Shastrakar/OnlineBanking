...
public class CustomerController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<CreateCustomerDTO> getCustomerByUserId(@PathVariable Long userId,
    ...
    public ResponseEntity<CreateCustomerDTO> getCustomerById(@PathVariable Long id,
            @RequestHeader(value = "bank-correlation-id", required = false) String correlationId) {
    ...
    @GetMapping("/getall")
    public ResponseEntity<List<CreateCustomerDTO>> getAllCustomers(
            @RequestHeader(value = "bank-correlation-id", required = false) String correlationId) {
    ...
    public ResponseEntity<String> uploadDoc(@PathVariable Long userId, @RequestPart("file") final MultipartFile file,
            @RequestHeader(value = "bank-correlation-id", required = false) String correlationId) throws IOException {
