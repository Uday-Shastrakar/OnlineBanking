...
public class BankingRolePermissionMapper {
    ...
    private Map<BankUserRole, Set<BankPermission>> initializeRolePermissions() {
        ...
        Set<BankPermission> customerUserPermissions = EnumSet.of(
        ...
        map.put(BankUserRole.CUSTOMER_USER, customerUserPermissions);
    ...
    public boolean validateRolePermissionMapping() {
        ...
        boolean customerUserValid = !hasPermission(BankUserRole.CUSTOMER_USER, BankPermission.ADMIN_MANAGE_CONFIG);
